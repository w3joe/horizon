...
export PYTHONPATH="$repo_root:$repo_root/packages/contracts/python:$repo_root/services/simulator:$repo_root/services/perception:$repo_root/services/neural-health${PYTHONPATH:+:$PYTHONPATH}"
