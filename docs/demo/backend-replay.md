...
- `GET /api/demo/runs/unsafe-route-v4` returns `{manifest, ...replay}` after checking the directory ID, schemas, clean-source marker, size cap, and replay SHA-256.
